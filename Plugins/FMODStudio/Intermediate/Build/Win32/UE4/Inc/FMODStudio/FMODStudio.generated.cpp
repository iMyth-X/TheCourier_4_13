...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventInstance
{
	...
	{
		FNativeFunctionRegistrar::RegisterFunction(UFMODBlueprintStatics::StaticClass(), "BusSetFaderLevel",(Native)&UFMODBlueprintStatics::execBusSetFaderLevel);
...
// Cross Module References
	...
	FMODSTUDIO_API class UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel();
	...
	FMODSTUDIO_API class UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_VCASetFaderLevel();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel()
	{
		struct FMODBlueprintStatics_eventBusSetFaderLevel_Parms
		{
			UFMODBus* Bus;
			float Level;
		};
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BusSetFaderLevel"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventBusSetFaderLevel_Parms));
			UProperty* NewProp_Level = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Level"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Level, FMODBlueprintStatics_eventBusSetFaderLevel_Parms), 0x0010000000000080);
			UProperty* NewProp_Bus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bus"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Bus, FMODBlueprintStatics_eventBusSetFaderLevel_Parms), 0x0010000000000080, Z_Construct_UClass_UFMODBus_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Set fader level on a bus\n@param Bus - bus to use\n@param Level - fader level"));
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_VCASetFaderLevel()
	{
		struct FMODBlueprintStatics_eventVCASetFaderLevel_Parms
		{
			UFMODVCA* Vca;
			float Level;
		};
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("VCASetFaderLevel"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventVCASetFaderLevel_Parms));
			UProperty* NewProp_Level = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Level"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Level, FMODBlueprintStatics_eventVCASetFaderLevel_Parms), 0x0010000000000080);
			UProperty* NewProp_Vca = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Vca"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Vca, FMODBlueprintStatics_eventVCASetFaderLevel_Parms), 0x0010000000000080, Z_Construct_UClass_UFMODVCA_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/FMODBlueprintStatics.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Set fader level on a VCA\n@param Vca - VCA to use\n@param Level - fader level"));
			MetaData->SetValue(ReturnFunction, TEXT("UnsafeDuringActorConstruction"), TEXT("true"));
#endif
		}
		return ReturnFunction;
	...
	UClass* Z_Construct_UClass_UFMODBlueprintStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel());
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UFMODBlueprintStatics_VCASetFaderLevel());

				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel(), "BusSetFaderLevel"); // 556705818
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFMODBlueprintStatics_VCASetFaderLevel(), "VCASetFaderLevel"); // 975563954
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
